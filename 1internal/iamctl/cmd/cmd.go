...
import (
	...
	"chat-go/1internal/iamctl/cmd/color"
	"chat-go/1internal/iamctl/cmd/completion"
	"chat-go/1internal/iamctl/cmd/info"
	"chat-go/1internal/iamctl/cmd/jwt"
	"chat-go/1internal/iamctl/cmd/new"
	"chat-go/1internal/iamctl/cmd/options"
	"chat-go/1internal/iamctl/cmd/policy"
	"chat-go/1internal/iamctl/cmd/secret"
	"chat-go/1internal/iamctl/cmd/set"
	"chat-go/1internal/iamctl/cmd/user"
	cmdutil "chat-go/1internal/iamctl/cmd/util"
	"chat-go/1internal/iamctl/cmd/validate"
	"chat-go/1internal/iamctl/cmd/version"
