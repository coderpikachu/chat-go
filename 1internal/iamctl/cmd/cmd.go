...
import (
	...
	"test/00Chat1/1internal/iamctl/cmd/color"
	"test/00Chat1/1internal/iamctl/cmd/completion"
	"test/00Chat1/1internal/iamctl/cmd/info"
	"test/00Chat1/1internal/iamctl/cmd/jwt"
	"test/00Chat1/1internal/iamctl/cmd/new"
	"test/00Chat1/1internal/iamctl/cmd/options"
	"test/00Chat1/1internal/iamctl/cmd/policy"
	"test/00Chat1/1internal/iamctl/cmd/secret"
	"test/00Chat1/1internal/iamctl/cmd/set"
	"test/00Chat1/1internal/iamctl/cmd/user"
	cmdutil "test/00Chat1/1internal/iamctl/cmd/util"
	"test/00Chat1/1internal/iamctl/cmd/validate"
	"test/00Chat1/1internal/iamctl/cmd/version"
